  ...
  module Service
    ...
    def self.invoke_unifiedorder(params, options = {})
      params = {
        ...
        mch_id: options.delete(:mch_id) || RequestStore[:wx].parter_id,
    ...
    def self.generate_app_pay_req(params, options = {})
      params = {
        appid: options.delete(:appid) || RequestStore[:wx].wx_app_id,
        partnerid: options.delete(:mch_id) || RequestStore[:wx].parter_id,
        package: 'Sign=WXPay',
    ...
    def self.invoke_transfer(params, options = {})
      params = {
        mch_appid: options.delete(:appid) || RequestStore[:wx].wx_app_id,
        mchid: options.delete(:mch_id) || RequestStore[:wx].parter_id,
        nonce_str: SecureRandom.uuid.tr('-', '')
      }.merge(params)
